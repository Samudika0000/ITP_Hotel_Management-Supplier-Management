...
<body class="overlay-scrollbar">
	...
	<div class="sidebar">
		<ul class="sidebar-nav">
			...
			<li class="sidebar-nav-item">
				<a href="StaffManagemnt.jsp" class="sidebar-nav-link">
					<div>
			...
			<li class="sidebar-nav-item">
				<a href="/supplier-management" class="sidebar-nav-link">
					<div>
						<i class="fa fa-user-o" aria-hidden="true"></i>
					</div>
					<span>
			...
			<li class="sidebar-nav-item">
				<a href="login.jsp" class="sidebar-nav-link">
					<div>
	...
	<div class="wrapper">
		<div class="row">
			...
			<div class="col-3 col-m-6 col-sm-6">
                            <a href="StaffManagemnt.jsp" style="color:#FFFFFF">
			...
			<div class="col-3 col-m-6 col-sm-6">
                            <a href="/supplier-management" style="color:#FFFFFF">
				<div class="counter bg-warning">
					<p>
						<i class="fas fa-spinner"></i>
					</p>
			...
			<div class="col-3 col-m-6 col-sm-6">
                            <a href="login.jsp" style="color:#FFFFFF">
				<div class="counter bg-danger">
					<p>
						<i class="fas fa-bug"></i>
					</p>
